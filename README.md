...
La situation est similaire (voire encore plus problématique) pour les services d'accès et d'usage d'IA d'entreprises américaines comme [ChatGPT d'Open AI](https://www.edpb.europa.eu/system/files/2024-05/edpb_20240523_report_chatgpt_taskforce_en.pdf).
